  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative container h-full mx-auto px-4 flex flex-col justify-center items-center text-center text-white">
        ...
        <p className="text-2xl md:text-3xl mb-10 max-w-3xl font-medium drop-shadow-md">
          프로페셔널한 레슨과 첨단 시스템으로 당신의 골프 실력을 한 단계
          높여드립니다
        </p>
        <button className="bg-gradient-to-r from-fuchsia-500 to-green-500 hover:from-fuchsia-600 hover:to-green-600 text-white font-bold py-4 px-10 rounded-full text-xl transition duration-300 shadow-lg cursor-pointer">
          레슨 예약하기
        </button>
